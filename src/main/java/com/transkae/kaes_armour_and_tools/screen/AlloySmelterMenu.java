...
public class AlloySmelterMenu extends AbstractContainerMenu {
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 26; //height in px of arrow
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.ALLOYSMELTER.get());
    }
